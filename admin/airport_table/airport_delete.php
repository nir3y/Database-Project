...
<BODY>
    <H2>[공항 삭제]</H2>
    <form method="post" action="airport_delete_result.php">
        <ul>
            <li>airport_id: <input type="text" name="airport_id" value=<?php echo $airport_id ?> READONLY></li>
            <li>airport_name: <input type="text" name="airport_name" value=<?php echo $airport_name ?> READONLY></li>
            <li>country: <input type="text" name="country" value=<?php echo $country ?> READONLY></li>
        </ul>
        위 공항을 삭제하시겠습니까? 
