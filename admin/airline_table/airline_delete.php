...
<BODY>
    <H2>[항공사 삭제]</H2>
    <form method="post" action="airline_delete_result.php">
        <ul>
            <li>airline_id: <input type="text" name="airline_id" value=<?php echo $airline_id ?> READONLY></li>
            <li>airline_name: <input type="text" name="airline_name" value=<?php echo $airline_name ?> READONLY></li>
            <li>website: <input type="text" name="website" value=<?php echo $website ?> READONLY></li>
        </ul>
        위 항공사를 삭제하시겠습니까? 
